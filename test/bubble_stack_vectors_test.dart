...
void main() {
  test('stack spacing accounts for every wrapped line in each block', () {
    ...
    expect(glossBubbleStackOffset(0.26, 0, lineCounts), closeTo(0.78, 1e-12));
    expect(glossBubbleStackOffset(0.26, 1, lineCounts), closeTo(0.52, 1e-12));
    expect(glossBubbleStackOffset(0.26, 2, lineCounts), 0);
  });
  ...
  test('stack Y is the line-aware offset', () {
    expect(glossBubbleStackY(0.26, 0, const <int>[2, 1]), closeTo(0.26, 1e-12));
  });
}
