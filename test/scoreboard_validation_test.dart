...
void main() {
  ...
  test('every complete presentation receives line and title validation', () {
    final GlossScoreboardDoc doc = _valid()
      ..variants.add(
    ...
    final List<String> paths = validateScoreboardDoc(
      doc,
    ).map((HuiIssue issue) => issue.path).toList();
    expect(paths, contains(r'$.variants[0].presentation.title'));
    expect(paths, contains(r'$.variants[0].presentation.lines[0]'));
  });
