...
class HelpDialog extends StatelessWidget {
      ...
      dom.div(classes: 'hui-axis', <Widget>[
        dom.div(classes: 'hui-axis-stage', <Widget>[
          dom.span(classes: 'hui-axis-tick is-menu', <Widget>[
            Text('menu centre  y 1.7  z 2.5'),
          ]),
          dom.span(classes: 'hui-axis-tick is-eye', <Widget>[
            Text('eye level  y 1.62'),
          ]),
          dom.span(classes: 'hui-axis-tick is-feet', <Widget>[
            Text("player's feet  y 0"),
          ]),
          dom.span(classes: 'hui-axis-ground', <Widget>[Text('ground')]),
        ]),
        HuiChips(
          labels: <String>[
            'x  right',
  ...
  Widget _textFormat() => HuiDialogSection(
    ...
    children: <Widget>[
      _cheatTable('Legacy codes', const <List<String>>[
      ...
      _cheatTable('MiniMessage subset', const <List<String>>[
      ...
      _cheatTable('Other rules', const <List<String>>[
        <String>[
          r'\n',
  ...
  Widget _customItems() => HuiDialogSection(
    ...
    children: <Widget>[
      ...
      _cheatTable('Provider ids and their id formats', <List<String>>[
  ...
  Widget _nonFeatures() => HuiDialogSection(
    ...
    children: <Widget>[
      dom.ul(classes: 'hui-nonfeatures', <Widget>[
        for (final String item in _nonFeatureList) dom.li(<Widget>[Text(item)]),
      ]),
    ],
  );
