...
/// `source` out: an omitted source dispatches from the console
/// (`CommandMenuAction.java:34-40`), which is the exact mistake these presets
/// exist to stop.
library;
  ...
  Widget build(BuildContext context) => dom.div(
        ...
        <Widget>[
          dom.div(
            ...
            <Widget>[
              _preset(
                ...
                hint: 'holoui open $menuId, as the player. Chaining menus is a '
              ...
              _preset(
                ...
                hint: 'holoui back, as the player. Reopens whichever menu they '
                    'had before this one.',
              ...
              _preset(
                ...
                hint: 'holoui close, as the player. Closes the session they are '
                    'clicking in.',
              ...
              _preset(
                ...
                hint: 'An empty command run as the clicking player, with their '
                    'own permissions.',
              ...
              _preset(
                ...
                hint: 'An empty command run from the server console, with full '
          ...
          const dom.p(
            ...
            <Widget>[
              Text(
                'Presets always write source, because a command that leaves it '
                'out runs from the console, not as the player. Open, back and '
                'close only work as the player - the console is not in a menu.',
              ),
            ],
          ),
        ],
