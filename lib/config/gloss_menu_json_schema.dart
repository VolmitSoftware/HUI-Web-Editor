  ...
  variants: <String, List<GlossJsonField>>{
    'text': <GlossJsonField>[
      ...
      const GlossJsonField(
        ...
        type: GlossJsonType.integer,
        title: 'Refresh ticks',
        summary: 'Re-render cadence for placeholder text. 20 ticks is a second.',
    ...
    'animatedTextImage': <GlossJsonField>[
      ...
      const GlossJsonField(
        ...
        type: GlossJsonType.integer,
        title: 'Speed',
        summary: 'Ticks per frame. Below 1 advances every tick.',
      ...
      const GlossJsonField(
        ...
        summary: 'The old name for source. Imports migrate it; Gson ignores it.',
        legacy: true,
      ),
    ],
    'item': <GlossJsonField>[
    ...
    'customItem': <GlossJsonField>[
      ...
      const GlossJsonField(
        ...
        type: GlossJsonType.string,
        title: 'Item id',
        summary: 'The provider\'s own id, verbatim. Several are case-sensitive.',
